...
import com.qiongsong.ficus.ibatis.builder.DynamicSqlSource;
import com.qiongsong.ficus.ibatis.builder.RawSqlSource;
  ...
  List<SqlNode> parseDynamicTags(XNode node) {
      ...
      for (int i = 0; i < children.getLength(); i++) {
        ...
        if (child.getNode().getNodeType() == Node.CDATA_SECTION_NODE || child.getNode().getNodeType() == Node.TEXT_NODE) {
          ...
          //判断SQL中是否有占位符号等，动态标签，通过Token Parse 来确定
          ...
          //不同的关键字节点处理. whereHandler foreachHandler 等
