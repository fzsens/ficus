...
/**
 * Offline entity resolver for the MyBatis DTDs MyBatis DTD校验
...
public class XMLMapperEntityResolver implements EntityResolver {
  ...
  private static final String MYBATIS_CONFIG_DTD = "com/qiongsong/ficus/ibatis/xml/mybatis-3-config.dtd";

  private static final String MYBATIS_MAPPER_DTD = "com/qiongsong/ficus/ibatis/xml/mybatis-3-mapper.dtd";
